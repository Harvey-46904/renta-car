...
<body>
    ...
    <section class="gauto-header-top-area">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="header-top-right"><a href="#"><i class="fa fa-key"></i> login</a><a href="#"><i
                                class="fa fa-user"></i> register</a>
                        <div class="dropdown"><button class="btn-dropdown dropdown-toggle" type="button"
                                id="dropdownlang" data-toggle="dropdown" aria-haspopup="true"><img
                                    src="{!! asset('webpage/img/en.png')!!}" alt="lang" />English</button>
                            <ul class="dropdown-menu" aria-labelledby="dropdownlang">
                                <li><img src="{!! asset('webpage/img/ca.png')!!}" alt="lang" />Canada</li>
                                <li><img src="{!! asset('webpage/img/fa.png')!!}" alt="lang" />French</li>
                                <li><img src="{!! asset('webpage/img/ja.png')!!}" />Japanese</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-12">
                    <div class="main-search-right">
                        ...
                        <div class="gauto-responsive-menu"></div><!-- Responsive Menu Start -->
                        <!-- Cart Box Start -->
                        <div class="header-cart-box">
                            <div class="login dropdown"><button class="dropdown-toggle cart-icon" type="button"
                                    id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false"><span>2</span></button>
                                <div class="dropdown-menu cart-dropdown" aria-labelledby="dropdownMenu1">
                                    <ul class="product_list">
                                        <li>
                                            <div class="cart-btn-product"><a class="product-remove" href="#"><i
                                                        class="fa fa-times"></i></a>
                                                <div class="cart-btn-pro-img"><a href="#"><img
                                                            src="{!! asset('webpage/img/cart-1.png')!!}" alt="product" /></a></div>
                                                <div class="cart-btn-pro-cont">
                                                    <h4><a href="#">CAR SPOILERS</a></h4>
                                                    <p>Quantity 2</p><span class="price">$29.99</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="cart-btn-product"><a class="product-remove" href="#"><i
                                                        class="fa fa-times"></i></a>
                                                <div class="cart-btn-pro-img"><a href="#"><img
                                                            src="{!! asset('webpage/img/cart-2.jpg')!!}" alt="product" /></a></div>
                                                <div class="cart-btn-pro-cont">
                                                    <h4><a href="#">CAR SPOILERS</a></h4>
                                                    <p>Quantity 2</p><span class="price">$29.99</span>
                                                </div>
                                    ...
                                    <div class="cart-subtotal">
                                        <p> Subtotal : <span class="drop-total">$59.98</span></p>
                                    </div>
                                    <div class="cart-btn"><a href="#" class="cart-btn-1">View Cart</a><a href="#"
                                            class="cart-btn-2">Checkout</a></div>
                                </div>
                            </div>
                        </div><!-- Cart Box End -->
                        <!-- Search Box Start -->
                        <div class="search-box">
                            <form><input type="search" placeholder="Search"><button type="submit"><i
    ...
    <section class="gauto-about-area section_70">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-left">
                        ...
                        <div class="about-signature">
                            <div class="signature-left"><img src="{!! asset('webpage/img/signature.png')!!}" alt="signature" /></div>
                ...
                <div class="col-lg-6">
                    <div class="about-right"><img src="{!! asset('webpage/img/about.png')!!}" alt="car" /></div>
                </div>
            </div>
        </div>
    ...
    <section class="gauto-promo-area">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="promo-box-left"><img src="{!! asset('webpage/img/toyota-offer-2.png')!!}" alt="promo car" /></div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="offer-tabs">
                        <ul class="nav nav-tabs" id="offerTab" role="tablist">
                            <li class="nav-item"><a class="nav-link active" id="all-tab" data-toggle="tab" href="#all"
                                    role="tab" aria-controls="all" aria-selected="true">All Brands</a></li>
                            <li class="nav-item"><a class="nav-link" id="nissan-tab" data-toggle="tab" href="#nissan"
                                    role="tab" aria-controls="nissan" aria-selected="false">nissan</a></li>
                            <li class="nav-item"><a class="nav-link" id="Toyota-tab" data-toggle="tab" href="#Toyota"
                                    role="tab" aria-controls="Toyota" aria-selected="false">Toyota</a></li>
                            <li class="nav-item"><a class="nav-link" id="Audi-tab" data-toggle="tab" href="#Audi"
                                    role="tab" aria-controls="Audi" aria-selected="false">Audi</a></li>
                            <li class="nav-item"><a class="nav-link" id="mercedes-tab" data-toggle="tab"
                                    href="#mercedes" role="tab" aria-controls="mercedes"
                                    aria-selected="false">mercedes</a></li>
                        </ul>
                        <div class="tab-content" id="offerTabContent">
                            ...
                            <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="single-offers">
                                            <div class="offer-image"><a href="#"><img src="{!! asset('webpage/img/offer-toyota.png')!!}"
                                                        alt="offer 1" /></a></div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-offers">
                                            <div class="offer-image"><a href="#"><img src="{!! asset('webpage/img/nissan-offer.png')!!}"
                                                        alt="offer 1" /></a></div>
                                            <div class="offer-text"><a href="#">
                                                    <h3>Nissan 370Z</h3>
                                                </a>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-offers">
                                            <div class="offer-image"><a href="#"><img src="{!! asset('webpage/img/audi-offer.png')!!}"
                                                        alt="offer 1" /></a></div>
                                            <div class="offer-text"><a href="#">
                                                    <h3>Audi Q3</h3>
                                                </a>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="single-offers">
                                            <div class="offer-image"><a href="#"><img src="{!! asset('webpage/img/bmw-offer.png')!!}"
                                                        alt="offer 1" /></a></div>
                                            <div class="offer-text"><a href="#">
                                                    <h3>BMW X3</h3>
                                                </a>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-offers">
                                            <div class="offer-image"><a href="#"><img
                                                        src="{!! asset('webpage/img/toyota-offer-2.png')!!}" alt="offer 1" /></a></div>
                                            <div class="offer-text"><a href="#">
                                                    <h3>Toyota Camry</h3>
                                                </a>
                            ...
                            </div><!-- Toyota Tab Start -->
                            <!-- Audi Tab Start -->
                            <div class="tab-pane fade" id="Audi" role="tabpanel" aria-labelledby="Audi-tab">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="single-offers">
                                            <div class="offer-image"><a href="#"><img src="{!! asset('webpage/img/audi-offer.pn')!!}g"
                                                        alt="offer 1" /></a></div>
                                            <div class="offer-text"><a href="#">
                                                    <h3>Audi Q3</h3>
                                                </a>
                            ...
                            <div class="tab-pane fade" id="mercedes" role="tabpanel" aria-labelledby="mercedes-tab">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="single-offers">
                                            <div class="offer-image"><a href="#"><img
                                                        src="{!! asset('webpage/img/marcedes-offer.png')!!}" alt="offer 1" /></a></div>
                                            <div class="offer-text"><a href="#">
                    ...
                    <div class="testimonial-slider owl-carousel">
                        <div class="single-testimonial">
                            <div class="testimonial-text">
                                <p>"Dorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusm tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                                    exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat adipisicing
                                    elit."</p>
                                <div class="testimonial-meta">
                                    <div class="client-image"><img src="{!! asset('webpage/img/testimonial.jpg')!!}" alt="testimonial" />
                                    </div>
                        ...
                        <div class="single-testimonial">
                            <div class="testimonial-text">
                                <p>"Forem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusm tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                                    exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat adipisicing
                                    elit."</p>
                                <div class="testimonial-meta">
                                    <div class="client-image"><img src="{!! asset('webpage/img/testimonial-2.jpg')!!}"
                                            alt="testimonial" /></div>
                                    <div class="client-info">
                                        <h3>Sherief Arafa</h3>
                                        <p>Customer</p>
    ...
    <section class="gauto-driver-area section_70">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single-driver">
                        <div class="driver-image"><img src="{!! asset('webpage/img/driver-1.jpg')!!}" alt="driver 1" />
                            <div class="hover">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-driver">
                        <div class="driver-image"><img src="{!! asset('webpage/img/driver-2.jpg')!!}" alt="driver 1" />
                            <div class="hover">
                                <ul class="social-icon">
                                    <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-driver">
                        <div class="driver-image"><img src="{!! asset('webpage/img/driver-4.jpg')!!}" alt="driver 1" />
                            <div class="hover">
                                <ul class="social-icon">
                                    <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-driver">
                        <div class="driver-image"><img src="{!! asset('webpage/img/driver-3.jpg')!!}" alt="driver 1" />
                            <div class="hover">
                                <ul class="social-icon">
                                    <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#"><i class="fa fa-twitter"></i></a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="load-more"><a href="#" class="gauto-btn">More Members</a></div>
                </div>
            </div>
        </div>
    </section><!-- Driver Area End -->
    <!-- Call Area Start -->
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-blog">
                        <div class="blog-image"><a href="#"><img src="{!! asset('webpage/img/blog-1.jpg')!!}" alt="blog 1" /></a></div>
                        <div class="blog-text">
                ...
                <div class="col-lg-4">
                    <div class="single-blog">
                        <div class="blog-image"><a href="#"><img src="{!! asset('webpage/img/blog-2.jpg')!!}" alt="blog 1" /></a></div>
                        <div class="blog-text">
                ...
                <div class="col-lg-4">
                    <div class="single-blog">
                        <div class="blog-image"><a href="#"><img src="{!! asset('webpage/img/blog-3.jpg')!!}" alt="blog 1" /></a></div>
                        <div class="blog-text">
                            ...
                            <ul>
                                <li>
                                    <div class="single-footer-post">
                                        <div class="footer-post-image"><a href="#"><img
                                                    src="{!! asset('webpage/img/post-thumb-3.jpg')!!}" alt="footer post" /></a></div>
                                        <div class="footer-post-text">
                                            <h3><a href="#">Revealed: How to set goals for you and your team</a></h3>
                                ...
                                <li>
                                    <div class="single-footer-post">
                                        <div class="footer-post-image"><a href="#"><img
                                                    src="{!! asset('webpage/img/post-thumb-2.jpg')!!}" alt="footer post" /></a></div>
                                        <div class="footer-post-text">
                                            <h3><a href="#">Revealed: How to set goals for you and your team</a></h3>
                                            <p>Posted on: Jan 12, 2019</p>
                                        </div>
                                ...
                                <li>
                                    <div class="single-footer-post">
                                        <div class="footer-post-image"><a href="#"><img
                                                    src="{!! asset('webpage/img/post-thumb-1.jpg')!!}" alt="footer post" /></a></div>
                                        <div class="footer-post-text">
                                            <h3><a href="#">apartment in the sky love three boys of his own.</a></h3>
                                            <p>Posted on: Jan 12, 2019</p>
                                        </div>
                                    </div>
                                </li>
