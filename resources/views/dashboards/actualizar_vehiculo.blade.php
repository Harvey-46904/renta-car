                ...
                <div class="col-lg-18 col-md-18 col-sm-18 col-xs-18">
                    <div class="card">
                        <div class="header">
                            ...
                            <hr>
                            <div class="container-fluid ">
                                <form method="POST" action="{{ route('actualizar_vehiculo', $vehiculo->id_vehiculo) }}" accept-charset="UTF-8"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6"><b>Nombre:</b> <input name="nombre_vehiculo" value="{{ $vehiculo->nombre_vehiculo }}">
                                            </div>
                                            <div class="col-md-6"><b>Placa:</b> <input name="placa" value="{{ $vehiculo->placa }}"> </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6"><b>Marca:</b><input name="marca" value="{{ $vehiculo->marca }}">  </div>
                                            <div class="col-md-6"><b>Modelo:</b> <input name="modelo" value="{{ $vehiculo->modelo }}"> </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6"><b>Seguro Soat:</b><input type="date" name="vigencia_soat" value="{{  date('Y-m-d', strtotime($vehiculo->vigencia_soat)) }}"> 
                                            </div>
                                            <div class="col-md-6"><b>Tecnomecanica:</b><input   type="date" name="vigencia_tecnomecanica" value="{{  date('Y-m-d', strtotime($vehiculo->vigencia_tecnomecanica)) }}">
                                                 </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6"><b>Precio Lavado:</b><input name="precio_lavado" value="{{ $vehiculo->precio_lavado }}">
                                                 </div>
                        ...
                        <div class="body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="switch">
                                        <label>No<input type="checkbox"  name="documento_dia"
                                                id="documento_dia" {{$vehiculo->documento_dia==1?"checked":""}}><span class="lever"></span>Si</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="switch">
                                        <label>No<input type="checkbox"  name="Luces_exteriores"
                                                id="Luces_exteriores" {{$vehiculo->Luces_exteriores==1?"checked":""}}><span class="lever"></span>Si</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="switch">
                                        <label>No<input type="checkbox"  name="Limpia_brisas"
                                                id="Limpia_brisas" {{$vehiculo->Limpia_brisas==1?"checked":""}}><span class="lever"></span>Si</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="switch">
                                        <label>No<input type="checkbox"  name="Espejos_externos_internos"
                                                id="Espejos_externos_internos" {{$vehiculo->Espejos_externos_internos==1?"checked":""}}><span
                                                class="lever"></span>Si</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="switch">
                                        <label>No<input type="checkbox"  name="Llanta_repuesto"
                                                id="Llanta_repuesto" {{$vehiculo->Llanta_repuesto==1?"checked":""}}><span class="lever"></span>Si</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="switch">
                                        ...
                                        {{$vehiculo->Cruceta==1?"checked":""}}><span
                                                class="lever"></span>Si</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="switch">
                                        <label>No<input type="checkbox"  name="Equipo_carretera"
                                                id="Equipo_carretera" {{$vehiculo->Equipo_carretera==1?"checked":""}}><span class="lever"></span>Si</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="switch">
                                        ...
                                        {{$vehiculo->Emblemas==1?"checked":""}}><span
                                                class="lever"></span>Si</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="switch">
                                        ...
                                        {{$vehiculo->Antena==1?"checked":""}}><span
                                                class="lever"></span>Si</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="switch">
                                        <label>No<input type="checkbox"  name="mantenimiento"
                                                id="mantenimiento" {{$vehiculo->mantenimiento==1?"checked":""}}><span class="lever"></span>Si</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="switch">
                                        ...
                                        {{$vehiculo->lavado==1?"checked":""}}><span
                                                class="lever"></span>Si</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1">Kilometraje</label>
                                     <input type="number" id="kilometraje" name="kilometraje"
                                         class="form-control bg-light text-center" placeholder="" value="{{$vehiculo->kilometraje}}"
                                        >
                                </div>
                                <div class="form-group">
