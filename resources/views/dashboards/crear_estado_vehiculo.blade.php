...
>>>>>>> ef4f53a5f599d587ea8bfd0068bef762b45c7205
                            </div>
                        </div>
                        <div class="body">
                            <form method="POST" action="{{ route('post_estado') }}" accept-charset="UTF-8"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="id_vehiculo" placeholder=""
                                        value="{{ $vehiculo->id_vehiculo }}" readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="f">Foto de Vehiculo - Lado Izquierdo</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control border border-secondary" id="observaciones"
