                                        ...
                                        <div class="form-group ">
                                            <div class="form-line">
                                                <input type="text" id="cedula_usuario" name="cedula_usuario"
                                                    class="form-control text-center" placeholder="Digite numero de documento">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="mensaje" name="mensaje"
                                                    class="form-control bg-warning text-center" placeholder="Cliente No Encontrado">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12 text-center border border-secondary py-2 ">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" id="id_cliente" name="id_cliente" class="text-center form-control bg-light "
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" id="documento" name="documento"
                                                            class="form-control bg-light text-center" placeholder="" value="" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
